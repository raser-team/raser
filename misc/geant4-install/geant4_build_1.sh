...
home_path=$PWD
echo "-----build geant4-----" 
mkdir -p $home_path/geant4/src
mkdir -p $home_path/geant4/build 
mkdir -p $home_path/geant4/install
mkdir -p $home_path/geant4/data 
wget https://geant4-data.web.cern.ch/releases/geant4.10.07.p02.tar.gz
tar xzf geant4.10.07.p02.tar.gz -C $home_path/geant4/src 
