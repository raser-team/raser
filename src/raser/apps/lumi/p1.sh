...
p1_current(){
  ...
  do
      ...
      cp src/raser/apps/lumi/cflm_p1.json ./tmp_event_folder
      ...
      sed -i "s|app_file_path(\"lumi\", \"cflm_p1.json\")|'$lumi_output/event_$count/event_$count.json'|g" "./tmp_event_folder/cflm_p1.py"
      ...
      sed -i "s|app_file_path(\"lumi\", \"cflm_p1.json\")|'$lumi_output/event_$count/event_$count.json'|g" "./tmp_event_folder/get_current_p1.py"
      ...
      sed -i "s|app_file_path(\"lumi\", \"cflm_p1.json\")|'$lumi_output/event_$count/event_$count.json'|g" "./tmp_event_folder/poisson_generator_p1.py"
