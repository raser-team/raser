...
from raser.supports.io_decorator import io_decorator as iod
...
def main():
    ...
    outputDir = project_path("telescope", "telescope_acts")
    create_path( outputDir)
    inputDir = component_path("acts")
